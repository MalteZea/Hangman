//Borrowed from https://raw.githubusercontent.com/dcode-youtube/hangman-rust/master/src/main.rs
...
fn main() {
    ...
    // let mut lettersUsed = BTreeSet::new();
    ...
    loop {
        ...
        // lettersUsed.insert(&letters);
        // for x in 0..lettersUsed.len {
        //     println!("{}", lettersUsed.get(x))
        // }
